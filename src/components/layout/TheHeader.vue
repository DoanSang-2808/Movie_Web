        ...
        <div class="col col-sm-9 col-xl-6">
          <div class="container-fluid height100">
            <div class="row height100">
              ...
              <div class="col-md-3 center hover">
                <span><i class="bi bi-search"></i></span>Tìm kiếm
              </div>
              <div class="col-md-2 center hover">Trang chủ</div>
              <div class="col-md-2 center hover">About</div>
              <div class="col-md-2 center hover">Liên hệ</div>
            </div>
          </div>
        </div>
